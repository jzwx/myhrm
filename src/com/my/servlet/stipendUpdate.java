...
public class stipendUpdate extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//System.out.println(id+" "+sid+" "+name+" "+basic+" "+eat+" "+house+" "+duty+" "+scot+" "+punishment+" "+other+" "+granttime+" "+totalize);
		...
		response.sendRedirect("Stipendlist.bin?nowPage="+pageCount);
	}
