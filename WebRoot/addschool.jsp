...
<form name="userForm" method="post" action="addSchool.bin" onSubmit="return userValidate();">
<div class="MainDiv">
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >毕业学校信息录入</th>
  </tr>
  <tr>
    <td class="CPanel">
				...
				<table width="100%" border="0" cellpadding="2" cellspacing="1" style="width:100%">
					<tr>
						...
						<span class="red">*</span></td>
				   		...
				   		<td width="43%">
				   		<input name="schoolclass" type="text" class="input" id="schoolclass" />
