...
<form name="userForm" method="post" action="addDept.bin" onSubmit="return userValidate();">
<div class="MainDiv">
			...
			<TD width="100%">
				...
				<table width="100%" border="0" cellpadding="2" cellspacing="1" style="width:100%">
					<tr>
						...
						<td width="36%">
						<input name="did" type="text" class="input" id="did"/>
						<span class="red">*</span></td>
				   		<td width="12%"><div align="right">部门名称：</div></td>
				   		<td width="43%">
				   		<input name="dname" type="text" class="input" id="dname" />
				      	<span class="red">*</span></tr>
					<tr>
						<tr>
						<td nowrap align="right" width="9%">管理人：</td>
						<td width="36%">
						<input name="lead" type="text" class="input" id="lead"/>
						<span class="red">*</span></td>
					<tr>
