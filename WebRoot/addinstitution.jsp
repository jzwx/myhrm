...
<form name="institutionForm" method="post" action="addInstitution.bin" onSubmit="return institutionValidate()">
<div class="MainDiv">
			...
			<TD width="100%">
				...
				<legend>奖惩信息</legend>
					  ...
					  <tr>
					    ...
					    <td><textarea name="explains" cols="100" rows="6" class="input" id="explains"></textarea></td>
					  </tr>
					  </table>
			  <br />
				</fieldset>			</TD>
